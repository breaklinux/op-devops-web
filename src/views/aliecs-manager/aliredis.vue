<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-button class="filter-item" @click="getupdataredisList()" type="danger">资源同步 </el-button>
    </div>
...
<script>
import {getRedisList, postRedisList, deleteRedis,  putEditRedis, getupdataRedisList } from '@/api/aliecs'
export default {
  data() {
    return {
      updatalistQuery: {
  ...
  methods: {
    ...
    getupdataredisList(){
      ...
      getupdataRedisList(updatalistQuery).then(response =>{  

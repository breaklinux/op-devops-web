<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-button class="filter-item" @click="updataEcsLis()" type="danger">资源同步 </el-button>
    </div>
...
<script>
import {getEcsList, getUpdataEcsList } from '@/api/aliecs'
export default {
  data() {
    return {
      updatalistQuery: {
  ...
  methods: {
    ...
    updataEcsLis(){
      ...
      getUpdataEcsList(updatalistQuery).then(response =>{  
